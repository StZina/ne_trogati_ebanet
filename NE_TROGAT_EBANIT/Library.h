...
void start() {
    ...
    cout << "Всего две компании откликнулись на ваше резюме, но назначили собеседование на одно и то же время.\nКакую компанию вы выберете?\n";
    cout << "1. Идти на собеседование в ООО Херовато\n";
    cout << "2. Идти на собеседование в ООО Херанука\n";
